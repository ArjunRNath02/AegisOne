...
from src.frames.home import HomeUI
from src.frames.scan import ScanUI
from src.frames.performance import PerformanceUI
from src.frames.update import UpdateUI
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalSpacer = QSpacerItem(20, 240, QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Minimum)
...
#if QT_CONFIG(tooltip)
        self.scanBtn.setToolTip(QCoreApplication.translate("MainWindow", u"View scanning details", None))
#endif // QT_CONFIG(tooltip)
        self.scanBtn.setText(QCoreApplication.translate("MainWindow", u"Scan", None))
#if QT_CONFIG(tooltip)
        self.updateBtn.setToolTip(QCoreApplication.translate("MainWindow", u"View database details", None))
#endif // QT_CONFIG(tooltip)
        self.updateBtn.setText(QCoreApplication.translate("MainWindow", u"Update", None))
#if QT_CONFIG(tooltip)
        self.perfBtn.setToolTip(QCoreApplication.translate("MainWindow", u"View performance details", None))
#endif // QT_CONFIG(tooltip)
